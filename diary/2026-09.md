...
## 2026-09-25 — clipping: The Kobeissi Letter — US 10Y above 5.20%

**Source:** pasted text shared by Luke (~25 Sep 2026); reads as The Kobeissi Letter; no URL given. Prior clip on 23 Sep had the 10Y at 5.13%.
...
## 2026-09-25 — clipping: Bill Ackman — Fed rates, AI demand and inflation

**Source:** pasted text shared by Luke (~25 Sep 2026); attributed to Bill Ackman; no URL given
...
## 2026-09-25 — clipping: memorial state dinner photo (current affairs)

**Source:** Getty Images photo (Kevin Dietsch) shared by Luke (~25 Sep 2026); no URL given

Memorial dinner photo — US–China state dinner setting. Trump at the podium; Xi toasting at table; Melania Trump and Peng Liyuan present; Elon Musk and Tim Cook among the guests at the round table.

![Memorial state dinner — Trump, Xi, Musk, Cook](assets/2026-09-25-trump-xi-state-dinner-musk-cook.jpg)

---

## 2026-09-25 — clipping: Nvidia CEO on AI and basic math

**Source:** pasted text shared by Luke (~25 Sep 2026); attributed to Nvidia ($NVDA) CEO; no URL given

“Basic math is being forgotten. Does it matter? I don't think it does.”

---

## 2026-09-25 — clipping: Garry Tan — personal AI agents not priced in (CPU/RAM)

**Source:** X screenshot shared by Luke (~25 Sep 2026); Garry Tan (@garrytan) quoting tae kim (@firstadopter); no URL given

Garry Tan: “This is not priced in yet”

Quoted — tae kim: “Imagine if one billion people used a personal AI agent. That's a lot of CPUs and memory”

Embedded Muse agent chat (per screenshot): agent VM = 2 CPUs, 7.7 GB RAM, ~7.5 GB disk; no local GPU — model runs on Meta’s servers; each Muse user gets a dedicated agent machine.

![Garry Tan — Muse agent CPU/RAM not priced in](assets/2026-09-25-garrytan-muse-agent-cpu-ram.png)
