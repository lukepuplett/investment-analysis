...
| **NET** | Cloudflare (`net/`) | Yes | 2025 Q4 | `2025_Q4_earnings_call_transcript.txt` | Aging — superseded by `cloudflare/` folder below |
...
| **CLOUDFLARE** | Cloudflare (`cloudflare/`) | Yes | 2026 Q1 | `2026_Q1_earnings_call_analysis.md` | Recent — canonical, newer than `net/` |
...
- **NET/Cloudflare** is tracked in two folders; `cloudflare/` (2026 Q1) is newer than `net/` (2025 Q4) and should be treated as canonical per README.
...
- **Refresh priority among held names** (staleness-ranked): RYCEY (H2 2025) > MSFT (FY2025 Q2) > SPCE (2025 Q2) > AMZN/DRO (2025 Q3) > NET (2025 Q4, though `cloudflare/` folder is current). GOOG/TSLA refreshed 2026-09-12.
