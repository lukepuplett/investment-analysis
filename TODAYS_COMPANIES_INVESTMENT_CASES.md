...
- **Multiple secular tailwinds**: GenAI infrastructure (+58% YoY Enterprise Network), solar ramp (+46% YoY), Apple partnership expansion ($2.5B U.S. manufacturing commitment)
- **$2B+ incremental opportunity** from GenAI optical demand
- **Solar target**: $2.5B revenue target by 2028
- **Market leadership**: #1 positions in optical fiber/cable and display glass
- **Strong customer relationships**: Apple, hyperscalers providing long-term visibility

### Valuation & Financials
- **Strong performance**: Q3 2025 core sales $4.27B (+14% YoY), operating margin 19.6% (+130 bps), EPS growth 24%
- **Robust cash flow**: $1.19B TTM free cash flow
- **Strong balance sheet**: $1.65B cash, manageable debt (76.5% debt/equity)
- **Reasonable valuation**: Forward P/E 28.99x, PEG 0.70 (attractive for growth)
- **Fair value**: $95-110 per share (9-26% upside from current $87.50)

### Investment Case Summary
**STRONG BUY** - Exceptional execution on Springboard plan with multiple secular growth drivers. Achieved margin target early, positioned for continued growth from GenAI infrastructure, solar expansion, and Apple partnership. Valuation attractive relative to growth profile and execution quality. Key catalysts: GenAI demand acceleration, solar ramp execution, margin expansion continuation.
...
- **Power generation dominance**: 40%+ orders growth, expected to end year up 20%+
- **GenAI leadership**: First GenAI advisors in industrial operations
- **Software growth**: Industrial software ACV at $1.5B, up 10% YoY
- **Market tailwinds**: LNG investments, data center power needs, automation adoption
- **Strong backlog**: $7.6B (excluding AspenTech) supporting growth visibility

### Valuation & Financials
- **Strong fundamentals**: $17.78B TTM revenue, 27.1% adjusted segment EBITA margin, $2.74B free cash flow
- **Resilient growth**: Process/hybrid markets showing strength, discrete recovery ongoing
- **Reasonable valuation**: Forward P/E 20.33x, EV/EBITDA 18.65x (quality premium justified)
- **Strong balance sheet**: $2.22B cash, manageable debt
- **Target price**: $160-170 (14-21% upside from current ~$140)
...
- **Aerospace growth**: 8%+ growth, record $7.4B backlog
- **Electrification expansion**: Strategic positioning in electrification trends
- **Record backlog**: $11B total ($7.4B aerospace) providing visibility
- **Market positioning**: Strong in aerospace aftermarket and industrial distribution
- **Decentralized model**: 85 divisions enabling market responsiveness

### Valuation & Financials
- **Exceptional margins**: Record 26.1% adjusted segment operating margin (+120 bps expansion)
- **Strong cash generation**: $3.8B operating cash flow (19% of sales), $3.3B free cash flow
- **Premium valuation**: 27.96x P/E, 19.32x EV/EBITDA (justified by exceptional margins)
- **EPS growth**: 24% growth despite flat revenue (1% organic) through margin expansion
...
- **World's largest renewable portfolio**: 32+ GW operational, 29.6 GW development backlog
- **Dual business model**: Regulated utility stability (FPL) + renewable growth (Energy Resources)
- **$40B planned FPL investments** supporting multi-year growth
- **6-8% annual earnings growth** through 2027 with clear visibility
- **Market positioning**: Serving hyperscalers and large load customers

### Valuation & Financials
- **Exceptional profitability**: 30.77% operating margin, 24.73% net margin (TTM)
- **Strong cash generation**: $12.21B operating cash flow TTM
- **Premium valuation**: P/E 27.24x, P/S 6.22x, EV/EBITDA 17.74x (justified by quality/growth)
- **High leverage**: 144% debt/equity requiring continued strong cash flow
- **Capital intensity**: -$21.68B investing cash flow TTM
- **Fair value**: $85-95 per share (4-16% upside)

### Investment Case Summary
**BUY** - Unique combination of regulated utility stability with renewable energy growth. Exceptional profitability and strong competitive position (world's largest renewable portfolio, largest development backlog). Premium valuation justified by quality, growth visibility, and competitive advantages. Suitable for long-term investors seeking quality growth with utility-like stability. Consistent dividend growth (~10% annually through at least 2026).
...
- **Data center boom**: AWS $10B investment in NC demonstrating competitive positioning
- **Southeast growth**: Population migration and advanced manufacturing creating demand
- **Strategic positioning**: Largest T&D system in U.S. (~320K miles) with scale advantages
- **5-7% EPS growth** through 2029 with clear visibility
- **Regulatory tailwinds**: Constructive outcomes in NC, SC, OH supporting capital recovery

### Valuation & Financials
- **Strong performance**: $30.85B TTM revenue, $4.73B net income
- **Reasonable valuation**: 19.9x trailing P/E, 18.2x forward P/E (reasonable for utility with growth)
- **High leverage**: 170% debt/equity but manageable with strong cash flow
- **Negative free cash flow**: -$1.61B TTM due to heavy capital investment
- **Dividend yield**: 3.44% with 2% annual growth commitment
- **Fair value**: $135-145 per share (10-15% upside from current $123.67)

### Investment Case Summary
**BUY for income-focused investors** - High-quality regulated utility positioned to capture structural Southeast growth trends. Strategic transactions ($7.5B proceeds) strengthen credit profile while enabling growth. 5-7% EPS growth combined with ~3.4% dividend yield offers ~8-10% total return potential. Strong regulatory support, proven execution, and diversified jurisdictions reduce risk. Suitable for 3-5 year investment horizon.
...
- **Capacity rationalization**: ~30M tons of global closures (10% of supply) rebalancing markets
- **Circular economy solutions**: MoReTec technology providing first-mover advantage
- **Technology leadership**: Proprietary technologies in polyolefins and circular economy
- **Recovery potential**: Deep cyclical trough with accelerating rationalization improving mid-term outlook
- **Market normalization**: Mature markets showing early recovery signs

### Valuation & Financials
- **Deep cyclical trough**: 0.41x Price/Sales, 12.99x Forward P/E (significantly below historical)
- **Strong balance sheet**: $6.5B liquidity, investment-grade rating maintained
- **Cash discipline**: Cash Improvement Plan targeting $600M incremental cash flow in 2025, $1.1B by end of 2026
- **Current performance**: Q3 2025 EBITDA $835M (excluding $1.2B write-downs), 135% cash conversion
- **Recovery potential**: Base case 30-50% upside, bull case 50-100% upside
- **Fair value**: Current price reflects deep trough with significant recovery potential
